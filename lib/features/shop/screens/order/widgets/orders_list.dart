                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('28 Feb, 2024', style: Theme.of(context).textTheme.headlineSmall),
                    ],
                  ),
                ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('[#123123]', style: Theme.of(context).textTheme.titleMedium),
                          ],
                        ),
                      ),
                    ],
                        ...
                        Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('02 June, 2024', style: Theme.of(context).textTheme.titleMedium),
                              ],
                            )
                        ),
                      ],
